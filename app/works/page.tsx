...
const works: Work[] = [
  ...
  },
  {
    ...
    description: 'Making AI feel human at institutional scale — conversational UI, admin console, and embeddable widgets deployed across educational institutions.',
    year: '2019–2022',
